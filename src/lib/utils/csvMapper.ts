...
function buildSheet2Row(f: RenewalApplicationFormData): string[] {
  ...
  return [
    ...
    /* [165] (11)労働、社会保険及び租税に関する法令の規定に違反したことの有無 */ bool(oath.hadLaborLawPenalty),
    /* [166] (11)有　内容入力欄 */ '',
    /* [167] (12)契約締結日前1年以内又は以後に、同種の業務の労働者を非自発的に離職させたことの有無 */ bool(oath.hadIllegalDismissal),
    /* [168] (12)有　内容入力欄 */ '',
    /* [169] (13)特定技能所属機関の責めに帰すべき事由により外国人の行方不明者を発生させたことの有無 */ bool(oath.hadMissingPersons),
    /* [170] (13)有　内容入力欄 */ '',
    ...
    // ── 登録支援機関 [243]〜[263] ────────────────────────────────────────
    /* [243] 登録支援機関 (1)氏名又は名称 */ ei.supportAgencyName ?? '',
    /* [244] 登録支援機関 (2)法人番号の有無 */ '',
    /* [245] 登録支援機関 (2)法人番号 */ '',
    /* [246] 登録支援機関 (3)雇用保険適用事業所番号 */ '',
    /* [247] 登録支援機関 (4)郵便番号 */ '',
    /* [248] 登録支援機関 (4)所在地(都道府県) */ '',
    /* [249] 登録支援機関 (4)所在地(市区町村) */ '',
    /* [250] 登録支援機関 (4)所在地(町名丁目番地号等) */ '',
    /* [251] 登録支援機関 (4)電話番号 */ '',
    /* [252] 登録支援機関 (5)代表者の氏名 */ '',
    /* [253] 登録支援機関 (6)登録番号 */ ei.supportAgencyRegistrationNumber ?? '',
    /* [254] 登録支援機関 (7)登録年月日 */ '',
