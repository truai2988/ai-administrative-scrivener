...
import { z } from 'zod';
import { changeOfStatusApplicationSchema } from '@/lib/schemas/changeOfStatusApplicationSchema';

type ChangeOfStatusApplicationFormData = z.infer<typeof changeOfStatusApplicationSchema>;
...
export const generateChangeOfStatusCsvU = (data: ChangeOfStatusApplicationFormData): Uint8Array => {
  const headers = [
    ...
    "申請人に関する情報等_良好に修了した技能実習2号２_申請時における特定技能1号での通算在留期間(年数)",
    "申請人に関する情報等_良好に修了した技能実習2号２_申請時における特定技能1号での通算在留期間(月数)",
    "申請人に関する情報等_良好に修了した技能実習2号２_特定技能雇用契約に係る保証金の徴収その他財産管理又は違約金等の支払契約の有無",
    "申請人に関する情報等_良好に修了した技能実習2号２_徴収・管理機関名",
    "申請人に関する情報等_良好に修了した技能実習2号２_徴収金額・管理財産",
    "申請人に関する情報等_良好に修了した技能実習2号２_取次ぎ又は活動準備に関する外国の機関への費用支払について、合意していることの有無",
    "申請人に関する情報等_良好に修了した技能実習2号２_外国の機関名",
    "申請人に関する情報等_良好に修了した技能実習2号２_支払額",
    "申請人に関する情報等_良好に修了した技能実習2号２_国籍国等において定められる本邦で行う活動に関連して遵守すべき手続を経ていることの有無",
    "申請人に関する情報等_良好に修了した技能実習2号２_本邦において定期的に負担する費用について、対価の内容を十分に理解して合意していることの有無",
    "申請人に関する情報等_良好に修了した技能実習2号２_技能実習によって本邦において修得、習熟又は熟達した技能等の本国への移転に努めることの有無",
    "申請人に関する情報等_良好に修了した技能実習2号２_申請人につき特定産業分野に特有の事情に鑑みて告示で定められる基準に適合していることの有無",
    "申請人に関する情報等_良好に修了した技能実習2号２_職歴の有無",
    ...
    "所属機関に関する情報等_特定技能所属機関_(4)業種_他業種_その他",
    ...
    "所属機関に関する情報等_(1)特定技能雇用契約の内容等を外国人が十分に理解できる言語による情報提供の実施の有無",
    "所属機関に関する情報等_(2)上記(1)について対面又はテレビ電話装置その他の方法により行うこととしていることの有無",
    "所属機関に関する情報等_(3)出入国時に港又は飛行場への送迎をすることとしていることの有無",
    "所属機関に関する情報等_1号特定技能外国人支援計画_(4)適切な住居の確保に係る支援をすることとしていることの有無",
    "所属機関に関する情報等_(5)金融機関における預金口座等の生活に必要な契約に係る支援をすることとしていることの有無",
    "所属機関に関する情報等_(6)本邦での生活一般に関する事項等を外国人が十分に理解できる言語により実施することの有無",
    "所属機関に関する情報等_(7)関係機関への同行その他の必要な措置を講ずることとしていることの有無",
    "所属機関に関する情報等_1号特定技能外国人支援計画_(8)日本語を学習する機会を提供することとしていることの有無",
    "所属機関に関する情報等_(9)外国人が理解できる言語により相談又は苦情の申出に対して必要な措置を講ずることの有無",
    "所属機関に関する情報等_(10)外国人と日本人の交流の促進に係る支援をすることとしていることの有無",
    "所属機関に関する情報等_(11)外国人が責めに帰すべき事由によらず契約を解除される場合は、転職支援をすることの有無",
    "所属機関に関する情報等_(12)支援責任者等が定期面談を実施し、問題発生時は関係行政機関に通報することの有無",
    "所属機関に関する情報等_(13)支援計画を作成し、当該外国人にその写しを交付することとしていることの有無",
    "所属機関に関する情報等_(14)特定産業分野に特有の事情に鑑みて告示で定められる事項を支援計画に記載することの有無",
    "所属機関に関する情報等_(15)支援の内容が外国人の適正な在留に資するものであって、かつ適切に実施できることの有無",
    "所属機関に関する情報等_(16)支援計画の内容につき告示で定められる基準に適合していることの有無",
  ...
  rowData.push(
    formatBoolean(sPlan?.preGuidanceProvision),
    formatBoolean(sPlan?.preGuidanceInPerson),
...
export const downloadChangeOfStatusCsvU = (data: ChangeOfStatusApplicationFormData, filename = '申請情報入力(区分U)_1.csv') => {
  const uint8Array = generateChangeOfStatusCsvU(data);
